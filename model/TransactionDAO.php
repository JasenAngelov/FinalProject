...
class TransactionDAO {
	...
	public function createTransaction( $sum, $recipientIBAN, $reason, $recipientName,$type, $aditionalReason=null) {
		...
		$encAditionalReason=($aditionalReason === null)? $aditionalReason : openssl_encrypt ( $aditionalReason, 'AES-256-CBC', $key, OPENSSL_RAW_DATA, $iv); 
